...
You have to design & build the backend for the application and the ability for the users to search tourist places, accommodation and itineraris.
...
https://github.com/azaylamba/delhi-tourism 
